  ...
  return <motion.div initial={{
    ...
    opacity: 1
      ...
      delay: 0.2
        ...
        <motion.img src="https://media.giphy.com/media/BzyTuYCmvSORqs1ABM/giphy.gif" alt="Happy excited cat" initial={{
        opacity: 0,
        scale: 0.5
      }} animate={{
        opacity: 1,
        ...
        delay: 1.5
      }} className="mt-12 text-lg text-muted-foreground flex items-center justify-center gap-2">Happy Valentines to my sweet baby girl!!
I'm so grateful to have you in my life, my love. </motion.p>
      </motion.div>
    </motion.div>;
};
